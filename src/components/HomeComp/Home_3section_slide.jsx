      ...
      <div className="section3-mainContainer">
        ...
        <div className="section-fourth-home w-screen h-screen">
          ...
          <div className="card" id="card-1">
            <img ref={imgRef1} src="https://res.cloudinary.com/drwfctvfs/image/upload/v1756058589/img1_m9tyg0.jpg" alt="" />
          </div>
          <div className="card" id="card-2">
            <img ref={imgRef2} src="https://res.cloudinary.com/drwfctvfs/image/upload/v1756058588/img4_kuo5vp.jpg" alt="" />
          </div>
          <div ref={imgRef3} className="card" id="card-3">
            <img src="https://res.cloudinary.com/drwfctvfs/image/upload/v1756058584/img3_prugkq.jpg" alt="" />
          </div>
          <div ref={imgRef4} className="card" id="card-4">
            <img src="https://res.cloudinary.com/drwfctvfs/image/upload/v1756058585/img2_prut9d.jpg" alt="" />
          </div>
